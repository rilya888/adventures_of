-- Adventures Of: Initial schema (Block 11)
-- Digital books only (MVP)

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Users (guest or auth; auth.users synced via trigger)
...
CREATE UNIQUE INDEX idx_users_auth ON public.users(auth_user_id) WHERE auth_user_id IS NOT NULL;
...
-- Assets (photos, generated images)
...
-- RLS (Row Level Security) - enable for Supabase
