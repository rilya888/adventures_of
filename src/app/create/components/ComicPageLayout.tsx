...
export function ComicPageLayout({
  ...
  const renderCaption = () => {
    ...
    if (isSideOverlay) {
      ...
      return (
        <div
          className={`absolute top-4 bottom-4 z-10 flex flex-col justify-center overflow-y-auto
    ...
    return (
      <div
        className={`absolute left-0 right-0 z-10 px-3 py-2 text-sm font-medium text-amber-950
